...
var taskInput=document.getElementById("new-task__id-for-input");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="task-item__input";
    editInput.type="text";
...
var addTask=function(){
    ...
    //Create a new list item with the text from the #new-task__id-for-input:
